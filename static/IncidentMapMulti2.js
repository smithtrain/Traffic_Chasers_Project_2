...
d3.json(url, function(response) {
  ...
  var icons = {
    ...
    PLANNED_EVENT: L.ExtraMarkers.icon({
      icon: "ion-android-bicycle",
      iconColor: "white",
      markerColor: "green",
      shape: "circle"
    }),
    ROAD_CLOSURE: L.ExtraMarkers.icon({
      icon: "ion-android-bicycle",
      iconColor: "white",
      markerColor: "green",
      shape: "circle"
  ...
  for (var i = 0; i < response.length; i++) {
    ...
    if (Incident.Traffic_type == "ACCIDENT") {
     ...
     var IncidentMarker = L.marker([Incident.Latitude, Incident.Longitude,],{icon: icons[Incident.Traffic_type]});    
      IncidentMarker.bindPopup("<h3>Type: " + Incident.Traffic_type + "<h3><h3>Description: " + Incident.ItemDescr + "<h3><h3>Criticiality: " + Incident.CritDescr + "<h3><h3>Criticiality: " + Incident.Start_Time + "<h3><h3>Criticiality: " + Incident.End_Time + "<h3>");
      ...
      // For each Incident, create a marker and bind a popup with the Incident's type, description, and criticality
      var IncidentMarker = L.marker([Incident.Latitude, Incident.Longitude,],{icon: icons["PLANNED_EVENT"]});
      IncidentMarker.bindPopup("<h3>Type: " + Incident.Traffic_type + "<h3><h3>Description: " + Incident.ItemDescr + "<h3><h3>Criticiality: " + Incident.CritDescr + "<h3><h3>Criticiality: " + Incident.Start_Time + "<h3><h3>Criticiality: " + Incident.End_Time + "<h3>");
